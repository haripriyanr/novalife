  ...
  Future<void> _updatePassword() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        widget.onPasswordResetCompleted?.call();

        await Future.delayed(const Duration(seconds: 1));
        if (mounted && widget.onPasswordResetCompleted == null) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        leading: widget.onPasswordResetCompleted != null
            ? IconButton(
          icon: const Icon(Icons.close),
          onPressed: widget.onPasswordResetCompleted,
        )
            : null,
      ),
